...
If you've forgotten your admin password, don't worry! Below you'll find step-by-step guides to reset your admin password for Docker 🐳 deployments and local installations of Open TutorAI.

## For Docker Deployments 🐳

Follow these steps to reset the admin password for Open TutorAI when deployed using Docker.
...
If you have a local installation of Open TutorAI, here's how you can reset your admin password directly on your system.
...
If you want to **completely reset** Open TutorAI—including all user data, settings, and passwords—follow these steps to remove the `webui.db` file.
...
📖 By following these straightforward steps, you'll regain access to your Open TutorAI admin account in no time. If you encounter any issues during the process, please consider searching for your issue on forums or community platforms.
