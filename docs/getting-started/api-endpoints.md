...
To ensure secure access to the API, authentication is required 🛡️. You can authenticate your API requests using the Bearer Token mechanism. Obtain your API key from **Settings > Account** in the Open TutorAI, or alternatively, use a JWT (JSON Web Token) for authentication.
...
- **Description**: Fetches all models created or added via Open TutorAI.
- **Example**:
...
- **Description**: Serves as an OpenAI API compatible chat completion endpoint for models on Open TutorAI including Ollama models, OpenAI models, and Open TutorAI Function models.
...
## Advantages of Using Open TutorAI as a Unified LLM Provider

Open TutorAI offers a myriad of benefits, making it an essential tool for developers and businesses alike:
...
Access detailed API documentation for different services provided by Open TutorAI:
...
By following these guidelines, you can swiftly integrate and begin utilizing the Open TutorAI API. Should you encounter any issues or have questions, feel free to reach out through our Discord Community or consult the FAQs. Happy coding! 🌟
