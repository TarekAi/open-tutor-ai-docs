...
Open TutorAI makes it easy to connect and manage your **Ollama** instance. This guide will walk you through setting up the connection, managing models, and getting started.

---

## Step 1: Setting Up the Ollama Connection

Once Open TutorAI is installed and running, it will automatically attempt to connect to your Ollama instance. If everything goes smoothly, you’ll be ready to manage and use models right away.
...
To manage your Ollama instance in Open TutorAI, follow these steps:

1. Go to **Admin Settings** in Open TutorAI.
...
If you’re looking for a faster option to get started, you can download models directly from the **Model Selector**. Simply type the name of the model you want, and if it’s not already available, Open TutorAI will prompt you to download it from Ollama.
...
That’s it! Once your connection is configured and your models are downloaded, you’re ready to start using Ollama with Open TutorAI. Whether you’re exploring new models or running your existing ones, Open TutorAI makes everything simple and efficient.
