...
## 🌊 What Are Filters in Open TutorAI?

Imagine Open TutorAI as a **stream of water** flowing through pipes:
...
In the world of Open TutorAI, the `inlet` function does this important prep work on the **user input** before it’s sent to the model. It ensures the input is as clean, contextual, and helpful as possible for the AI to handle.  

📥 **Input**:  
- **`body`**: The raw input from Open TutorAI to the model. It is in the format of a chat-completion request (usually a dictionary that includes fields like the conversation's messages, model settings, and other metadata). Think of this as your recipe ingredients.
...
#### 🆕 3️⃣ **`stream` Hook (New in Open TutorAI 0.5.17)**

##### 🔄 What is the `stream` Hook?
The **`stream` function** is a new feature introduced in Open TutorAI **0.5.17** that allows you to **intercept and modify streamed model responses** in real time.
...
🚀 **Your Turn**: Start experimenting! What small tweak or context addition could elevate your Open TutorAI experience? Filters are fun to build, flexible to use, and can take your models to the next level!  
